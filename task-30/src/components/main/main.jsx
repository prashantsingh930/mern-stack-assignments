          ...
          <article className='overflow-hidden border border-gray-300 bg-white shadow-md'>
            <div className='relative'>
              <img
                ...
                src='https://images.unsplash.com/photo-1638486071986-bbcac55fc52c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHNrYXRlciUyMGJveXxlbnwwfHwwfHx8MA%3D%3D'
                alt='Blog'
              />
            </div>
